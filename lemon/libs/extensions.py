...
class extensions:
    ...
    def cgi(self,ext,file,object):
        import_lib = f"app/extensions/{self.extensions['cgi'][ext][list(self.extensions['cgi'][ext])[0]]['location']}/{self.extensions['cgi'][ext][list(self.extensions['cgi'][ext])[0]]['extension-main-file']}"
